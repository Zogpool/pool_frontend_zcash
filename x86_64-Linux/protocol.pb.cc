...
void protobuf_AssignDesc_protocol_2eproto() {
  ...
  static const int ClientStats_offsets_[12] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ClientStats, unittype_),
  };
  ...
  static const int Share_offsets_[18] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Share, bignonce_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Share, proofofwork_),
  };
  Share_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Share_descriptor_,
  ...
  static const int Work_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Work, hashreserved_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Work, n_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Work, k_),
  };
  Work_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Work_descriptor_,
...
void protobuf_AddDesc_protocol_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "\n\005ngpus\030\017 \002(\r\022\016\n\006height\030\020 \002(\r\022\020\n\010unitTyp"
    "e\030\021 \001(\r\"\254\002\n\005Share\022\014\n\004addr\030\001 \002(\t\022\014\n\004name\030"
    "\002 \002(\t\022\020\n\010clientid\030\003 \002(\006\022\r\n\005gpuid\030\004 \001(\r\022\014"
    "\n\004hash\030\n \002(\t\022\016\n\006merkle\030\013 \002(\t\022\014\n\004time\030\014 \002"
    "(\r\022\014\n\004bits\030\r \002(\r\022\r\n\005nonce\030\016 \002(\r\022\r\n\005multi"
    "\030\017 \002(\t\022\021\n\tblockhash\030\020 \001(\t\022\016\n\006height\030\024 \002("
    "\r\022\016\n\006length\030\025 \002(\r\022\021\n\tchaintype\030\026 \002(\r\022\017\n\007"
    "isblock\030\027 \002(\010\022\020\n\010genvalue\030\030 \001(\004\022\020\n\010bigNo"
    "nce\030\031 \001(\t\022\023\n\013proofOfWork\030\032 \001(\014\"\211\002\n\007Reque"
    "st\022&\n\004type\030\001 \002(\0162\030.pool.proto.Request.Ty"
    "pe\022\r\n\005reqid\030\002 \002(\r\022\017\n\007version\030\n \001(\r\022\016\n\006he"
    "ight\030\013 \001(\r\022\020\n\010reqnonce\030\014 \001(\014\022 \n\005share\030\024 "
    "\001(\0132\021.pool.proto.Share\022&\n\005stats\030\025 \001(\0132\027."
    "pool.proto.ClientStats\"J\n\004Type\022\010\n\004NONE\020\000"
    "\022\013\n\007CONNECT\020\001\022\013\n\007GETWORK\020\002\022\t\n\005SHARE\020\003\022\t\n"
    "\005STATS\020\004\022\010\n\004PING\020\005\"G\n\nServerInfo\022\014\n\004host"
    "\030\001 \002(\t\022\016\n\006router\030\002 \002(\r\022\013\n\003pub\030\003 \002(\r\022\016\n\006t"
    "arget\030\004 \002(\r\"n\n\004Work\022\016\n\006height\030\001 \002(\r\022\016\n\006m"
    "erkle\030\002 \002(\t\022\014\n\004time\030\003 \002(\r\022\014\n\004bits\030\004 \002(\r\022"
    "\024\n\014hashReserved\030\005 \001(\t\022\t\n\001n\030\006 \001(\r\022\t\n\001k\030\007 "
    "\001(\r\"\304\002\n\005Reply\022&\n\004type\030\001 \002(\0162\030.pool.proto"
    ".Request.Type\022\r\n\005reqid\030\002 \002(\r\022(\n\005error\030\n "
    "\002(\0162\031.pool.proto.Reply.ErrType\022\016\n\006errstr"
    "\030\013 \001(\t\022%\n\005sinfo\030\024 \001(\0132\026.pool.proto.Serve"
    "rInfo\022\036\n\004work\030\025 \001(\0132\020.pool.proto.Work\022 \n"
    "\005block\030\026 \001(\0132\021.pool.proto.Block\"a\n\007ErrTy"
    "pe\022\010\n\004NONE\020\000\022\013\n\007VERSION\020\001\022\n\n\006HEIGHT\020\002\022\014\n"
    "\010REQNONCE\020\003\022\t\n\005STALE\020\004\022\013\n\007INVALID\020\005\022\r\n\tD"
    "UPLICATE\020\006\"p\n\010ReqStats\022)\n\007reqtype\030\001 \002(\0162"
    "\030.pool.proto.Request.Type\022*\n\007errtype\030\002 \002"
    "(\0162\031.pool.proto.Reply.ErrType\022\r\n\005count\030\003"
    " \002(\r\"\202\001\n\013ServerStats\022\014\n\004name\030\001 \002(\t\022\016\n\006th"
    "read\030\002 \002(\r\022\017\n\007workers\030\n \002(\r\022\017\n\007latency\030\013"
    " \002(\r\022\013\n\003cpd\030\014 \002(\002\022&\n\010reqstats\030\024 \003(\0132\024.po"
    "ol.proto.ReqStats\"\204\001\n\004Data\022 \n\005share\030\001 \001("
    "\0132\021.pool.proto.Share\022,\n\013clientstats\030\002 \001("
    "\0132\027.pool.proto.ClientStats\022,\n\013serverstat"
    "s\030\003 \001(\0132\027.pool.proto.ServerStats", 1912);
...
const int ClientStats::kUnitTypeFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 16: {
        ...
        if (input->ExpectTag(136)) goto parse_unitType;
        break;
      }
...
void ClientStats::SerializeWithCachedSizes(
  ...
  // optional uint32 unitType = 17;
  if (has_unittype()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(17, this->unittype(), output);
  }
...
::google::protobuf::uint8* ClientStats::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 unitType = 17;
  if (has_unittype()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(17, this->unittype(), target);
  }
...
const int Share::kBigNonceFieldNumber;
const int Share::kProofOfWorkFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 24: {
        ...
        if (input->ExpectTag(202)) goto parse_bigNonce;
        break;
      }
      ...
      case 25: {
        if (tag == 202) {
         parse_bigNonce:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_bignonce()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->bignonce().data(), this->bignonce().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "bignonce");
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(210)) goto parse_proofOfWork;
        break;
      }
        ...
        if (tag == 210) {
         parse_proofOfWork:
          DO_(::google::protobuf::internal::WireFormatLite::ReadBytes(
                input, this->mutable_proofofwork()));
        } else {
          goto handle_unusual;
        }
        if (input->ExpectAtEnd()) goto success;
...
void Share::SerializeWithCachedSizes(
  ...
  if (has_bignonce()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "bignonce");
    ::google::protobuf::internal::WireFormatLite::WriteStringMaybeAliased(
      25, this->bignonce(), output);
  }

  // optional bytes proofOfWork = 26;
  if (has_proofofwork()) {
    ::google::protobuf::internal::WireFormatLite::WriteBytesMaybeAliased(
      26, this->proofofwork(), output);
  }
...
void Share::MergeFrom(const Share& from) {
  ...
  if (from._has_bits_[16 / 32] & (0xffu << (16 % 32))) {
    if (from.has_bignonce()) {
      set_bignonce(from.bignonce());
    }
    if (from.has_proofofwork()) {
      set_proofofwork(from.proofofwork());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void Share::Swap(Share* other) {
  if (other != this) {
    ...
    std::swap(bignonce_, other->bignonce_);
...
const int Work::kHashReservedFieldNumber;
const int Work::kNFieldNumber;
const int Work::kKFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 4: {
        ...
        if (input->ExpectTag(42)) goto parse_hashReserved;
        break;
      }
      ...
      case 5: {
        if (tag == 42) {
         parse_hashReserved:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->mutable_hashreserved()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->hashreserved().data(), this->hashreserved().length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "hashreserved");
        } else {
          goto handle_unusual;
      ...
      case 6: {
        ...
        if (input->ExpectTag(56)) goto parse_k;
        break;
      }
...
void Work::SerializeWithCachedSizes(
  ...
  // optional uint32 k = 7;
  if (has_k()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(7, this->k(), output);
  }
...
::google::protobuf::uint8* Work::SerializeWithCachedSizesToArray(
  ...
  // optional uint32 k = 7;
  if (has_k()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(7, this->k(), target);
  }
...
void Work::MergeFrom(const Work& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_hashreserved()) {
      set_hashreserved(from.hashreserved());
    }
    if (from.has_n()) {
      set_n(from.n());
    }
...
void Work::Swap(Work* other) {
  if (other != this) {
    ...
    std::swap(time_, other->time_);
    std::swap(bits_, other->bits_);
    std::swap(hashreserved_, other->hashreserved_);
